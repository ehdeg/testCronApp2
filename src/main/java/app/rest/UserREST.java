...
public class UserREST {
  ...
  public HttpEntity<PagedResources<User>> findUsersByCompany(@PathVariable("companyId") java.lang.String companyId, Pageable pageable, PagedResourcesAssembler assembler) {
    return new ResponseEntity<>(assembler.toResource(userBusiness.findUsersByCompany(companyId, pageable)), HttpStatus.OK);
  }
}
